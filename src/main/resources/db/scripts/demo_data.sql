...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `employee_id`, `role`,`is_supervisor`,`logged`) VALUES (2, 'pablo', '$2a$12$HbC4Qa3XDqoUIxtia5o19OptfHIeQccF1kWapk9yRztFlafnwoE4i', true, 2, 'HR',1,0);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `employee_id`, `role`,`is_supervisor`,`logged`) VALUES (5, 'evihr', '$2a$12$HbC4Qa3XDqoUIxtia5o19OptfHIeQccF1kWapk9yRztFlafnwoE4i', true, 5, 'HR',1,0 );
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `employee_id`, `role`,`is_supervisor`,`logged`) VALUES (3, 'areti', '$2a$12$HbC4Qa3XDqoUIxtia5o19OptfHIeQccF1kWapk9yRztFlafnwoE4i', true, 3, 'Employee',0,0 );
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `employee_id`, `role`,`is_supervisor`,`logged`) VALUES (4, 'kleftis', '$2a$12$HbC4Qa3XDqoUIxtia5o19OptfHIeQccF1kWapk9yRztFlafnwoE4i', true, 4, 'Employee',0,0 );
