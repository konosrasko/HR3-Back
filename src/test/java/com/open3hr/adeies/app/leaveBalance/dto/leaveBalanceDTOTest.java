...
public class leaveBalanceDTOTest {
    ...
    public void EntityToDTO(){
        ...
        LeaveBalanceDTO myLeaveBalanceEntityToDTO = new LeaveBalanceDTO(myLeaveBalance,myLeaveCategory);

        assertThat(myLeaveBalanceDTO.equals(myLeaveBalanceEntityToDTO)).isTrue();
    }
}
